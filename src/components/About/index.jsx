...
const aboutContent = [
    "Greetings! I am Brian Hopper, I reside in Bossier City, LA. I hold a B.A. in Cellular and Molecular Biology, a Masters in Health Science, and an MBA in Project Management all received from Louisiana State University Shreveport.",
    "Furthermore, I have completed my certifications in Lean Six Sigma Green Belt and Lean Practitioner. I have also completed my Scrum Master Certification.",
    "As a full-stack software engineer, I bring a rare combination of life sciences education, operations expertise (Lean Six Sigma, Scrum), and hands-on software delivery. I specialize in building dynamic, scalable web applications using modern technologies — particularly valuable for healthtech, biotech, and operations-heavy SaaS teams.",
